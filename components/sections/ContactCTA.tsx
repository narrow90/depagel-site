          ...
          <div className="max-w-3xl">
            ...
            <div className="mt-8 flex flex-col gap-4 sm:flex-row">
              <Link
                ...
                className=" rounded-full justify-center bg-[#046DB6] px-7 py-3 text-sm font-regular text-white shadow-lg shadow-[#046DB6]/20 transition hover:bg-[#035A95] lg:inline-flex"
              >
                E-Mail
              </Link>
